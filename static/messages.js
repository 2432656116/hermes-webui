    ...
    source.addEventListener('done',e=>{
      ...
      const _finishDone=()=>{
        ...
        if(isActiveSession){
          ...
          // #4650: invalidate reasoning-chip cache at turn boundary so
          // syncTopbar refetches the authoritative effort exactly once.
          if(typeof _lastReasoningFetchKey!=='undefined') _lastReasoningFetchKey=null;
          syncTopbar();renderMessages(shouldFollowOnDone?{}:{preserveScroll:true});
